...
if( isset($_SESSION['active']) && $_SESSION['active']){
    ...
    if( !empty($_POST) ){
        ...
        $properties = $properties_controller->get($id_user, $contract, $city, $type, $rooms = 0, $bedrooms = 0, $currency, $price_min, $price_max, false, $status);
    
    } 
    else{
        $properties = $properties_controller->get($id_user, $contract);
    }

    /* Properties
    ==============================================================*/

    $template_start_section = "
    <section class=''>
        <h2>Administrar propiedades</h2>";
    $template_add_property = "
    <form method='POST'>
    ...
    echo $template_start_section;
    echo $template_add_property;
    echo $template_table_header;
    echo $template_property;
    echo $template_end_section;
